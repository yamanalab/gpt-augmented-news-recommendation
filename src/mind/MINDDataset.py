...
from const.mind import EMPTY_IMPRESSION_IDX, EMPTY_NEWS_ID
...
if __name__ == "__main__":
    from const.path import MIND_SMALL_VAL_DATASET_DIR, MIND_SMALL_TRAIN_DATASET_DIR
    from torch.utils.data import DataLoader
    from transformers import AutoTokenizer
    from utils.logger import logging
    from utils.random_seed import set_random_seed

    from src.mind.dataframe import read_behavior_df, read_news_df, create_user_ids_to_idx_map
    ...
    train_behavior_df, train_news_df = (
        read_behavior_df(MIND_SMALL_TRAIN_DATASET_DIR / "behaviors.tsv"),
        read_news_df(MIND_SMALL_TRAIN_DATASET_DIR / "news.tsv"),
    )
